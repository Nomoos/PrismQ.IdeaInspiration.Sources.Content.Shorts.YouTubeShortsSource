...
- **From YouTube API**: ~15 fields
- **From yt-dlp**: ~25 additional fields
- **Calculated metrics**: ~10 derived fields

### Easy to Add (High Priority)
- **No extra cost**: ~15 fields (already in responses)
- **Low cost (+2 quota)**: ~5 fields (status information)
