"""Story detection module for identifying story-based content.

This module provides functionality to detect if a video is likely a story video
based on its metadata, including title, description, tags, and subtitles.
"""
